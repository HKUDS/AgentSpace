...
- 单元测试覆盖签名、challenge、归一化、outbound、route、OAuth start/callback/exchange、CLI help、settings data/action、settings client 兼容性、socket worker 和 health/readiness/smoke dry-run。

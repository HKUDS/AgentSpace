...
- live smoke evidence artifact 会记录 AgentSpace workspace / integration context，以及 redacted app/team reference；strict final evidence 只接受与当前 workspace/integration 匹配的 live proof，避免复用其他 Slack 集成的 artifact 误通过。
